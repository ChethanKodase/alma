...
cd alma
conda activate dt2
python diffae/defense_efficacy_test.py --desired_norm_l_inf 0.33 --which_gpu 7 --diffae_checkpoint ../diffae/checkpoints --ffhq_images_directory ../diffae/imgs_align_uni_ad --noise_directory diffae/noise_storage

python diffae/defense_efficacy_test.py --desired_norm_l_inf 0.33 --which_gpu 7 --diffae_checkpoint ../diffae/checkpoints --ffhq_images_directory ../diffae/imgs_align_uni_ad --noise_directory ../diffae/attack_run_time_univ/attack_noise    # to get classic attacks 



cd alma
conda activate dt2
python diffae/defense_efficacy_test.py --desired_norm_l_inf 0.3 --which_gpu 2 --diffae_checkpoint ../diffae/checkpoints --ffhq_images_directory ../diffae/imgs_align_uni_ad --noise_directory diffae/noise_storage

cd alma
conda activate dt2
python diffae/defense_efficacy_test.py --desired_norm_l_inf 0.27 --which_gpu 3 --diffae_checkpoint ../diffae/checkpoints --ffhq_images_directory ../diffae/imgs_align_uni_ad --noise_directory diffae/noise_storage
