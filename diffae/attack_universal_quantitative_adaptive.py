...
attack_types = ["la_cos_mcmc2", "grill_cos_mcmc2"]
...
for j in range(len(attack_types)):
    optimized_noise = torch.load(""+noise_directory+"/DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_.pt").to(device)
    optimized_noise = torch.load(""+noise_directory+"/DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_.pt").to(device)
    ...
    for source_im in big_tensor:
        ...
        if(k%20==0):
            with torch.no_grad():
                ...
                plt.axis('off')
                plt.show()
                plt.savefig("../diffae/attack_qualitative_untargeted_univ_quantitative/images2/adv_DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_segment_"+str(k)+".png", bbox_inches='tight')
                plt.close()

                plt.imshow(recons_unp[0].cpu().detach().permute(1, 2, 0).cpu().numpy())
                plt.axis('off')
                plt.show()
                plt.savefig("../diffae/attack_qualitative_untargeted_univ_quantitative/images2/recon_DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_segment_"+str(k)+".png", bbox_inches='tight')
                plt.close()
        k+=1
        if(k==400):
            break
    np.save("../diffae/attack_qualitative_untargeted_univ_quantitative/deviations_p2/adv_divs_DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_segment_"+str(source_segment)+".npy", all_divs_for_attack)
    np.save("../diffae/attack_qualitative_untargeted_univ_quantitative/deviations_p2/adv_recons_DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_segment_"+str(source_segment)+".npy", all_recon_loss)
    np.save("../diffae/attack_qualitative_untargeted_univ_quantitative/deviations_p2/adv_divs_wass_DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_segment_"+str(source_segment)+".npy", all_adv_div_wass)
    np.save("../diffae/attack_qualitative_untargeted_univ_quantitative/deviations_p2/adv_divs_abs_DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_segment_"+str(source_segment)+".npy", all_adv_abs_deviation)
    np.save("../diffae/attack_qualitative_untargeted_univ_quantitative/deviations_p2/adv_divs_wass_DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_segment_"+str(source_segment)+".npy", all_adv_wass_deviation)
    np.save("../diffae/attack_qualitative_untargeted_univ_quantitative/deviations_p2/ssim_DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_segment_"+str(source_segment)+".npy", all_ssim_value)
    np.save("../diffae/attack_qualitative_untargeted_univ_quantitative/deviations_p2/psnr_DiffAE_attack_type"+str(attack_types[j])+"_norm_bound_"+str(desired_norm_l_inf)+"_segment_"+str(source_segment)+".npy", all_psnr_value)
