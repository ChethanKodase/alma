...
cd ..
cd alma/
python nvae/nvae_all_kids_of_attacks_universal.py --attck_type "alma_l2" --desired_norm_l_inf 0.035 --data_directory data_cel1 --nvae_checkpoint_path ../NVAE/pretrained_checkpoint
